...
<div class="docs-page">
	...
	{:else}
		<div class="page-header">
			...
			<button type="button" class="refresh-btn" onclick={() => loadDocs()} disabled={loading}>
		...
		{#if error}
			<div class="error-message">
				<p>{error}</p>
				<button type="button" onclick={() => loadDocs()}>Try Again</button>
			</div>
		...
		{:else}
			...
			{#if nextPageToken}
				<div class="load-more">
					<button type="button" onclick={() => loadDocs(nextPageToken)} disabled={loading}>
